exports.loadSubmit = function(req, res) {
  ...
  if (wahlkreisID == undefined || electorID == undefined) {
    ...
    pg.connect(db.connectionString, function(err, client, done) {
      ...
      if(erststimme == undefined || erststimme == null)
        erststimme = "noErststimme";
      if(zweitstimme == undefined || zweitstimme == null)
        zweitstimme = "noZweitstimme";
  ...
  function submitVote() {
    ...
    pg.connect(db.connectionString, function(err, client, done) {
      ...
      if (erststimme == "noErststimme" && zweitstimme == "noZweitstimme" || erststimme == "noErststimme" && zweitstimme == null || erststimme == null && zweitstimme == "noZweitstimme") {
        ...
        client.query("BEGIN; UPDATE elector SET vote2017=true WHERE id = " + electorID + "; INSERT INTO vote (year, zweitstimme, wahlkreis) VALUES (2017, " + zweitstimme + ", " + wahlkreisID + "); COMMIT;", function(err, result) {
      ...
      if (zweitstimme == "noZweitstimme" && erststimme != null) {
        client.query("BEGIN; UPDATE elector SET vote2017=true WHERE id = " + electorID + "; INSERT INTO vote (year, erststimme, wahlkreis) VALUES (2017, " + erststimme + ", " + wahlkreisID + "); COMMIT;", function(err, result) {
          console.log("gültige Erststimme und ungültige Zweitstimme");
          if (err) return rollback(client, err);
          else success();
        });
      } else if (erststimme != null && zweitstimme != null) {
        client.query("BEGIN; UPDATE elector SET vote2017=true WHERE id = " + electorID + "; INSERT INTO vote (year, erststimme, zweitstimme, wahlkreis) VALUES (2017, " + erststimme + ", " + zweitstimme + ", " + wahlkreisID + "); COMMIT;", function(err, result) {
